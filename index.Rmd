...
shiny::fluidRow(
  shiny::column(12, shiny::h3("Add Single Trial")),
  ...
  shiny::column(12, shiny::actionButton("button_add", "Add trial"))
),
...
shiny::fluidRow(
  shiny::column(12, shiny::h3("Add Multiple Trials via CSV File")),
...
shiny::fluidRow(
  shiny::column(12, shiny::h3("Remove or Archive Trial")),
  ...
  shiny::column(6,
    ...
    # shiny::textOutput("choices_list")  # Optional debug output
  ),
...
shiny::fluidRow(
  shiny::column(12, shiny::h3("Add or Amend Trial Comments")),
