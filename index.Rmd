...
first_seen AS (
  SELECT "{id_col}", MIN(date("mtime")) AS "Date Added"
  FROM "{source_table}"
  GROUP BY "{id_col}"
),
n AS (
  ...
  WHERE date(t."mtime") >= date(''{cutoff_iso}'')
),
o AS (
  SELECT t.*
  FROM "{source_table}" t
...
nct_sql <- glue('
WITH
{with_scaffold("ClinicalTrialsGov_Status", "NCTId", "NCT_Ids", cutoff_str)},
diffs AS (
  SELECT
    ...
    COALESCE(n."LastUpdatePostDate", o."LastUpdatePostDate", n."mtime", o."mtime") AS "When",
  ...
  SELECT
    ...
    COALESCE(n."LastUpdatePostDate", o."LastUpdatePostDate", n."mtime", o."mtime"),
...
diffs AS (
  SELECT
    ...
    COALESCE(n."Results_date_posted", n."Results_date_completed", o."Results_date_posted", o."Results_date_completed", n."mtime", o."mtime") AS "When",
  ...
  SELECT
    ...
    COALESCE(n."Results_date_posted", n."Results_date_completed", o."Results_date_posted", o."Results_date_completed", n."mtime", o."mtime"),
...
diffs AS (
  SELECT
    ...
    COALESCE(n."mtime", o."mtime") AS "When",
...
eu_sql <- glue('
WITH
{with_scaffold("ClinicalTrialsEU", "EU_Ids", "ClinicalTrialsEU_Ids", cutoff_str)},
diffs AS (
  SELECT
    COALESCE(n."Program", o."Program") AS "Program",
    COALESCE(n."Guideline.number", o."Guideline.number") AS "Guideline.number",
    ...
    COALESCE(n."p_date_of_the_global_end_of_the_trial",
             o."p_date_of_the_global_end_of_the_trial",
             n."mtime", o."mtime") AS "When",
