...
main_con <- DBI::dbConnect(RSQLite::SQLite(), file.path("data", "RSQLite_Data", "TrialTracker-db.sqlite"))
...
**Last refreshed: `r file.info("data/RSQLite_Data/TrialTracker-db.sqlite")$mtime |> format.POSIXct(digits = 0)`**
