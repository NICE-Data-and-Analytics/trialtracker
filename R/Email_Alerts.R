...
NCT_Changes_COVID <-
  pull_change(
    ...
    exclude_cols = c(
      "Query_Date", "Condition", "BriefTitle", "Acronym",
...
write_changes_to_disk(ISRCTN_Changes_COVID, "ISRCTN_COVID")
write_changes_to_disk(ISRCTN_Changes_IP, "ISRCTN_IP")
write_changes_to_disk(ISRCTN_Changes_Surv_Oth, "ISRCTN_OTH")
