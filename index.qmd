...
## Columns aren't working (tabset?) but it is more spaced out which is better
...
to_add <- shiny::reactive({
  ...
  upload <- readr::read_csv(file = inFile$datapath, col_types = readr::cols(.default = col_character()))
})
