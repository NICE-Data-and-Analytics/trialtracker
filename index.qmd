...
DBI::dbReadTable(main_con, "ISRCTN") |>
  ...
  dplyr::select(Program, Guideline, `Date Added`, URL, `ISRCTN ID`, Title, Acronym, `Scientific Title`, `Recruitment Status`, `Results URL`, `Results summary`, `Results completed date`, `Results posted date`, `Results published date`, Comments) |> 
